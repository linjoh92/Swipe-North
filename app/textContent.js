const languageText = {
    ...
    eng: {
      ...
      share: 'Share',
      title: 'SWIPE NORTH',
      description1: 'Swipe North is a revolutionary app that makes it easier than ever to find jobs in Skellefteå.',
      description2: 'With a functionality similar to the popular dating app Tinder, it is now possible to easily search for jobs and network with companies and recruiters in a way that is easy, fun and intuitive.',
       //matchJob page
      match: 'Matched jobs',
